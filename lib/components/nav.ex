defmodule SweepIt.Component.Nav do
  ...
  def init( current_scene, opts ) do
    ...
    |> dropdown({[
        {"Sensor", SweepIt.Scene.Sensor},
        {"Primitives", SweepIt.Scene.Primitives},
        {"Components", SweepIt.Scene.Components},
        {"Transforms", SweepIt.Scene.Transforms},
